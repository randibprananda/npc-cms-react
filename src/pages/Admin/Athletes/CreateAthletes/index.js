...
import { usePostAthletes } from "../../../../hooks/fetch/athletes/usePostAthletes";
...
const initialValues = {
  ...
  silver_medal: "",
  bronze_medal: "",
  paralympic_sport_type: "",
  image: "",
};

const athleteSchema = z.object({
  atheletes_name: z.string({
    required_error: "Name Athletes tidak boleh kosong",
  }),
  atheletes_regional: z.string({
    required_error: "Region of Origin tidak boleh kosong",
  }),
  atheletes_debute: z.string({ required_error: "Debute tidak boleh kosong" }),
  atheletes_birthdate: z.string({
    required_error: "Date of Birth tidak boleh kosong",
  }),
  atheletes_class: z.string({ required_error: "Class tidak boleh kosong" }),
  atheletes_biography: z.string({
    required_error: "Biography tidak boleh kosong",
  }),
  paralympic_sport_type: z.string({
    required_error: "Sport type tidak boleh kosong",
  }),
...
const CreateAthletes = () => {
  ...
  const handleGoldResult = () => {
    ...
    if (
      ...
      showToastMessage(
        "Data gagal ditambahkan, lengkapi inputan anda",
        "error"
      );
      return;
    }
  ...
  const { mutate: postAthletes } = usePostAthletes({
    onSuccess: () => {
      showToastMessage("Data berhasil ditambahkan", "success");
      navigate(-1);
    },
  ...
  const openModalDeleteSilver = (rowIndex) => {
    setDeleteIndexSilver(rowIndex); // Set the index to delete
    setModalDelete(true);
  };

  const openModalDeleteBronze = (rowIndex) => {
    setDeleteIndexBronze(rowIndex); // Set the index to delete
    setModalDelete(true);
  };
        ...
        <div className="w-screen -my-2 overflow-hidden">
          ...
          <div className="px-8 py-[70px]">
            <div className="py-[33px] px-[34px] shadow-card rounded-[10px]">
              <h1 className="mb-8 text-xl font-bold">Add Athletes</h1>
              <div className="mb-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    formik.setFieldValue("atheletes_name", e.target.value)
                  }
                />
                <span className="text-red-500">
                  {formik.errors.atheletes_name}
                </span>
              </div>
              ...
              <div className="mb-4">
                ...
                <span className="text-red-500">
                  {formik.errors.paralympic_sport_type}
                </span>
              </div>
              <div className="mb-4">
                <h1 className="text-base font-bold text-[#40444C] mb-2.5">
                ...
                <input
                  ...
                  onChange={(e) =>
                    formik.setFieldValue("atheletes_birthdate", e.target.value)
                  }
                />
                <span className="text-red-500">
                  {formik.errors.atheletes_birthdate}
                </span>
              </div>
              <div className="mb-4">
                <h1 className="text-base font-bold text-[#40444C] mb-2.5">
                ...
                <input
                  ...
                  onChange={(e) =>
                    formik.setFieldValue("atheletes_regional", e.target.value)
                  }
                />
                <span className="text-red-500">
                  {formik.errors.atheletes_regional}
                </span>
              </div>
              <div className="mb-4">
                  ...
                  <div className="w-full">
                    ...
                    <NumberInput
                      ...
                      onValueChange={(newValue) =>
                        formik.setFieldValue("gold_medal", goldResult.length)
                      }
                    />
                    <span className="text-red-500">
                      {formik.errors.gold_medal}
                    </span>
                  </div>
                  <div className="w-full">
                    <h1 className="text-base font-bold text-[#40444C] mb-2.5">
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    formik.setFieldValue("atheletes_debute", e.target.value)
                  }
                />
                <span className="text-red-500">
                  {formik.errors.atheletes_debute}
                </span>
              </div>
              <div className="mb-4">
                <h1 className="text-base font-bold text-[#40444C] mb-2.5">
                ...
                <input
                  ...
                  onChange={(e) =>
                    formik.setFieldValue("atheletes_class", e.target.value)
                  }
                />
                <span className="text-red-500">
                  {formik.errors.atheletes_class}
                </span>
              </div>
              <div className="mb-4">
                <h1 className="text-base font-bold text-[#40444C] mb-2.5">
                ...
                />
                <span className="text-red-500">
                  {formik.errors.atheletes_biography}
                </span>
              </div>
              <div className="mb-4">
                <h1 className="text-base font-bold text-[#40444C] mb-2.5">
              ...
              <div className="flex gap-6 justify-end mt-[50px]">
                ...
                <button
                  type="submit"
                  className="bg-[#EE393E] hover:bg-[#d63430] transition duration-300 px-8 py-2 font-bold rounded-[10px] text-md text-white"
                >
                  Create
                </button>
              </div>
        ...
        {modalAddGold === true && (
          <div className="fixed top-0 bottom-0 left-0 right-0 z-50 flex items-center justify-center w-full h-auto bg-opacity-50 bg-slate-800">
            <div class="bg-white w-[729px] px-[59px] py-[30px] rounded-lg text-center">
              ...
              <h1 class="text-2xl font-bold mb-10 text-black">
                Result Gold Medals
              </h1>
            ...
            <div class="bg-white w-[729px]  px-[59px] py-[30px] rounded-lg text-center">
              ...
              <div className="flex justify-center gap-6">
                ...
                <button
                  type="button"
                  className="bg-[#EDEEF1] px-8 py-2 font-bold rounded-[10px] text-md text-[#25272C]"
                  onClick={() => setModalAddSilver(false)}
                >
                  Cancel
                </button>
              </div>
            ...
            <div class="bg-white w-[729px]  px-[59px] py-[30px] rounded-lg text-center">
              ...
              <div className="flex justify-center gap-6">
                ...
                <button
                  type="button"
                  className="bg-[#EDEEF1] px-8 py-2 font-bold rounded-[10px] text-md text-[#25272C]"
                  onClick={() => setModalAddBronze(false)}
                >
                  Cancel
                </button>
              </div>
        ...
        {modalDelete === true && (
          ...
          >
            <div className="bg-white w-[729px] px-16 py-14 rounded-lg text-center">
              ...
              <h1 className="text-lg mb-[52px] text-black">
                Are you sure you want to delete this data?
              </h1>
              <div className="flex justify-center gap-6">
                <button
                  type="button"
                  className="bg-[#EE393E] hover:bg-[#d63430] transition duration-300 px-8 py-2 font-bold rounded-md text-md text-white"
            ...
            <div class="bg-white w-[729px]  px-[59px] py-[30px] rounded-lg text-center">
              ...
              <div className="flex justify-center gap-6">
                ...
                <button
                  type="button"
                  className="bg-[#EDEEF1] px-8 py-2 font-bold rounded-[10px] text-md text-[#25272C]"
                  onClick={() => setModalEditGold(false)}
                >
                  Cancel
                </button>
              </div>
                              ...
                              {column === "No" ? (
                                ...
                                <div className="flex gap-3">
                                  ...
                                  <button
                                    type="button"
                                    onClick={() =>
                                      openModalDeleteSilver(rowIndex)
                                    }
                                    className="bg-[#EE393E] hover:bg-[#d63430] transition duration-300 p-3 rounded-[5px] flex-shrink-0 flex"
                                  >
                                    <img src={IconDelete} alt="Delete" />
                              ...
                              {column === "No" ? (
                                ...
                                <div className="flex gap-3">
                                  ...
                                  <button
                                    type="button"
                                    onClick={() =>
                                      openModalDeleteBronze(rowIndex)
                                    }
                                    className="bg-[#EE393E] hover:bg-[#d63430] transition duration-300 p-3 rounded-[5px] flex-shrink-0 flex"
                                  >
                                    <img src={IconDelete} alt="Delete" />
