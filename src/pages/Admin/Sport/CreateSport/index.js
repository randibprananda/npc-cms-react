...
import { usePostSport } from '../../../../hooks/fetch/sport/usePostSport';
...
const CreateSport = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: () => {
      const data = {
        ...
        selected_top_news: selectedNews.length > 0 ? selectedNews.toString() : '[]',
        video: formik.values.video,
        image: formik.values.image,
        most_medal: formik.values.most_medal,
      };
      postSport(data);
    },
  });
  ...
  const { mutate: postSport } = usePostSport({
    onSuccess: () => {
        ...
        <div className='w-screen -my-2 overflow-hidden'>
          ...
          <div className='px-8 py-[70px]'>
            <div className='py-[33px] px-[34px] shadow-card rounded-[10px]'>
              <h1 className='mb-8 text-xl font-bold'>Add Sport</h1>
              <div className='mb-4'>
