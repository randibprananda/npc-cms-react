...
import { usePostAdmin } from '../../../../hooks/fetch/admin/usePostAdmin';
import { showToastMessage } from '../../../../lib/toast';

const CreateAdmin = () => {
  const { mutate: postAdmin } = usePostAdmin({
    onSuccess: () => {
        ...
        <div className='w-screen -my-2 overflow-hidden'>
          ...
          <div className='px-8 py-[70px] min-h-screen'>
            <div className='py-[33px] px-[34px] shadow-card rounded-[10px]'>
              <h1 className='mb-8 text-xl font-bold'>Add Admin</h1>
              <div className='mb-4'>
              ...
              <div className='mb-4'>
                <h1 className='text-base font-bold text-[#40444C] mb-2.5'>Email</h1>
                <input
                  className='appearance-none block w-full bg-light text-black border rounded-[12px] py-3 px-4 mb-[20px] leading-tight focus:outline-none focus:bg-white md:text-sm text-xs'
                  id='name'
                  type='text'
              ...
              <div className='mb-[50px]'>
                <h1 className='text-base font-bold text-[#40444C] mb-2.5'>Password</h1>
                <input
                  className='appearance-none block w-full bg-light text-black border rounded-[12px] py-3 px-4 mb-[20px] leading-tight focus:outline-none focus:bg-white md:text-sm text-xs'
                  id='name'
                  type='text'
